...
public class ToolSM extends ItemSM
{
    ...
    protected ToolSM(float p_i45333_1_, ToolMaterial p_i45333_2_, Set p_i45333_3_)
    {
        ...
        if (this instanceof PickaxeSM)
        {
            toolClass = "pickaxe";
        }
        else if (this instanceof AxeSM)
        {
            toolClass = "axe";
        }
        else if (this instanceof SpadeSM)
        {
            toolClass = "shovel";
        }
    }
